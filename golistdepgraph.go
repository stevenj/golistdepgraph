...
func main() {
	var (
		...
		highlightPrefixes = flag.String("h", "", "a comma-separated list of prefixes to highlight")
	...
	if *highlightPrefixes != "" {
		depContext.HighlightPrefixes = strings.Split(*highlightPrefixes, ",")
	}
	if *tagList != "" {
